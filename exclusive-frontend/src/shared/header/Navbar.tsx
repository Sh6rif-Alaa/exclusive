...
const Navbar = () => {
    const totalCartUnits = useAppSelector((state) => state.cart.items.length);
    const totalWishlistUnits = useAppSelector((state) => state.wishlist.items.length);
                        ...
                        <div className="md:hidden relative group">
                            ...
                            <div id="mobile-menu"
                                ...
                                <ul
                                    ...
                                    <NavLink to="/" className="border-b border-white/10 first:rounded-t-lg">
                                        Home
                                    </NavLink>
                                    <NavLink to="/contact-us" className="border-b border-white/10">
                                        Contact
                                    </NavLink>
                                    <NavLink to="/about-us" className="border-b border-white/10">
                                        About
                                    </NavLink>
                                    <NavLink to="/register" className="last:rounded-b-lg">
                                        Sign Up
                                    </NavLink>
                                </ul>
                            </div>
